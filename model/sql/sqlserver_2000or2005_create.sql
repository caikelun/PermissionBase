/*==============================================================*/
/* Database name:  PermissionBase                               */
/* DBMS name:      Microsoft SQL Server 2005                    */
/* Created on:     2006-9-17 20:22:30                           */
/*==============================================================*/
...
/* 自动收缩 */
ALTER DATABASE PermissionBase SET AUTO_SHRINK ON WITH NO_WAIT
GO

/* 简单还原模式 */
ALTER DATABASE PermissionBase SET RECOVERY SIMPLE WITH NO_WAIT
GO

/* 添加登录名 */
EXEC sp_addlogin 'PB_DB_USER', '1234567890', 'PermissionBase'
GO
