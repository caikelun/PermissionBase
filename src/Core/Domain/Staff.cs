...
namespace PermissionBase.Core.Domain
{
	...
	public class Staff
	{
        ...
        private NullableInt32 _married;
        ...
        private NullableDateTime _birthday;
        private NullableDateTime _enters_day;
        private NullableDateTime _leaves_day;
		...
		/// 婚否。
		/// </summary>
        public virtual NullableInt32 Married
		{
			get { return _married; }
			set { _married = value; }
		}
		...
		/// 出生日期。
		/// </summary>
        public virtual NullableDateTime Birthday
		{
		...
		/// 入职日期。
		/// </summary>
        public virtual NullableDateTime EntersDay
		{
		...
		/// 离职日期。
		/// </summary>
        public virtual NullableDateTime LeavesDay
		{
