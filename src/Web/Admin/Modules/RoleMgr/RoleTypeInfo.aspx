<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleTypeInfo.aspx.cs" Inherits="Admin_Modules_RoleMgr_RoleTypeInfo" EnableViewState="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Scripts/roleTypeInfo.js"></script>
            ...
            <table cellpadding="3" cellspacing="0" width="100%" border="0">
                ...
                <tr>
                    <td>
                        名称</td>
                    <td>
                        <input runat="server" type="text" id="txtRoleTypeName" maxlength="20" class="textBoxRed"
                ...
                <tr>
                    <td>
                        排序ID</td>
                    <td>
                        <input runat="server" type="text" id="txtRoleTypeOrderId" maxlength="9" class="textBoxRed"
                            style="width: 300px" /></td>
                </tr>
                <tr>
                    <td valign="top">
                        备注</td>
                    <td>
                        <textarea runat="server" id="txtaRoleTypeRemark" class="textBox" style="width: 300px;
