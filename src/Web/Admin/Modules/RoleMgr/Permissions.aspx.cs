...
public partial class Admin_Modules_RoleMgr_Permissions : System.Web.UI.Page
{
    private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(Admin_Modules_RoleMgr_Permissions));
    ...
    #region private void AddSubNodes(Microsoft.Web.UI.WebControls.TreeNode currentNode, ModuleType currentModuleType, Role role, SysCodeType sct)
