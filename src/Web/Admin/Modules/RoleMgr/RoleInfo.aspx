<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleInfo.aspx.cs" Inherits="Admin_Modules_RoleMgr_RoleInfo" EnableViewState="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Scripts/roleInfo.js"></script>
            ...
            <table cellpadding="3" cellspacing="0" width="100%" border="0">
                ...
                <tr>
                    <td>
                        名称</td>
                    <td>
                        <input runat="server" type="text" id="txtRoleName" maxlength="20" class="textBoxRed" style="width: 300px" /></td>
                </tr>
                <tr>
                    <td>
                        排序ID</td>
                    <td>
                        <input runat="server" type="text" id="txtRoleOrderId" maxlength="9" class="textBoxRed" style="width: 300px" /></td>
                </tr>
                <tr>
                    <td valign="top">
                        备注</td>
                    <td>
                        <textarea runat="server" id="txtaRoleRemark" class="textBox" style="width: 300px; height: 60px"></textarea></td>
                </tr>
            </table>
        </div>
