...
function btnSubmitClicked()
{
    try
    {
	    ...
	    var search = "?id=" + window.dialogArguments.id + "&newDepartmentPKId=" + newPKId;
    	
	    var succeed = XmlHttpHelper.transmit(false, "get", "text", "RemoteHandlers/MoveStaff.ashx" + search, null, null);
...
function _checkInputValue()
{
    ...
    if(oTree.selectedNodeIndex == "0" || oTree.selectedNodeIndex == window.dialogArguments.pIndex)
    {
