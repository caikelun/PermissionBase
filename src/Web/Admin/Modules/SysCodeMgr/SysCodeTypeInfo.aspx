<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SysCodeTypeInfo.aspx.cs"
    Inherits="Admin_Modules_SysCodeMgr_SysCodeTypeInfo" EnableViewState="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Scripts/sysCodeTypeInfo.js"></script>
            ...
            <table cellpadding="3" cellspacing="0" width="100%" border="0">
                ...
                <tr>
                    <td>
                        标示</td>
                    <td>
                        <input runat="server" type="text" id="txtSysCodeTypeTag" maxlength="20" class="textBoxRed"
                ...
                <tr>
                    <td>
                        名称</td>
                    <td>
                        <input runat="server" type="text" id="txtSysCodeTypeName" maxlength="20" class="textBoxRed"
                            style="width: 300px" /></td>
                </tr>
                <tr>
                    <td>
                        排序ID</td>
                    <td>
                        <input runat="server" type="text" id="txtSysCodeTypeOrderId" maxlength="9" class="textBoxRed"
                            style="width: 300px" /></td>
                </tr>
                <tr>
                    <td valign="top">
                        备注</td>
                    <td>
                        <textarea runat="server" id="txtaSysCodeTypeRemark" class="textBox" style="width: 300px;
